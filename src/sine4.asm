...
; 
update_all_waves:
    add byte [wave_phase1], 2
    add byte [wave_phase2], 5
    add byte [wave_phase3], 10
...
; =========================================================  
wave_phase1 db 0
wave_color1 db 0x0F    ; white

wave_phase2 db 40
wave_color2 db 0x0B    ; cyan

wave_phase3 db 80
wave_color3 db 0x09    ; blue
